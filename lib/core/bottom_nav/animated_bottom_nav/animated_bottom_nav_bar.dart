...
import 'package:rogonfluttertask/core/bottom_nav/animated_bottom_nav/around_custum_painter.dart';
import 'package:rogonfluttertask/core/bottom_nav/animated_bottom_nav/circular_notch_and_corner_clipper.dart';
import 'package:rogonfluttertask/core/bottom_nav/animated_bottom_nav/circular_notched_and_cornered_shape.dart';
import 'package:rogonfluttertask/core/bottom_nav/animated_bottom_nav/exceptions.dart';
import 'package:rogonfluttertask/core/bottom_nav/animated_bottom_nav/navigation_bar_item.dart';
...
class AnimatedBottomNavigationBar extends StatefulWidget {
  ...
  AnimatedBottomNavigationBar._internal(
    ...
    if (gapLocation == GapLocation.center) {
      final iconsCountIsOdd = (itemCount ?? widgets!.length).isOdd;
      if (iconsCountIsOdd) {
        throw NonAppropriatePathException(
...
class _AnimatedBottomNavigationBarState
  ...
  List<Widget> _buildItems() {
    ...
    final gapItemWidth = widget.notchAndCornersAnimation != null
        ...
        : gapWidth;
    final itemCount = widget.itemCount ?? widget.widgets!.length;
    ...
    for (var i = 0; i < itemCount; i++) {
      ...
      items.add(
        NavigationBarItem(
          ...
          widgets: widget.widgets?.elementAt(i),
